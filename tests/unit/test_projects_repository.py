...
async def test_claim_pending_projects():
    ...
    first_cursor_mock = AsyncMock()
    first_cursor_mock.to_list.return_value = [active_project]

    # Mock the second find to return the updated project
    second_cursor_mock = AsyncMock()
    second_cursor_mock.to_list.return_value = [active_project]
    ...
    mock_collection.find.assert_has_awaits([
